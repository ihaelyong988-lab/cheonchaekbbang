...
assert.match(sw, /ccb-v1\.7\.0/u, "서비스워커 캐시 버전이 v1.7.0이어야 합니다.");
...
console.log(JSON.stringify({ result: "pass", cachedAssets: cachedAssets.length, tabs: 4, templateOrder: true }, null, 2));
